...
public class ExcelReader {
	...
	private XSSFSheet getWorkBookSheet(String fileName, String sheetName) throws  IOException, InvalidFormatException {
		this.book = getWorkBook(fileName);
		return this.book.getSheet(sheetName);
	}

	private XSSFSheet getWorkBookSheet(String fileName, int sheetIndex) throws IOException, InvalidFormatException {
		this.book = getWorkBook(fileName);
		return this.book.getSheetAt(sheetIndex);
	}

	public List<List<String>> getSheetData() throws IOException, InvalidFormatException{
		XSSFSheet sheet;
	...
	public List<List<String>> getSheetDataAt() throws  IOException, InvalidFormatException {
