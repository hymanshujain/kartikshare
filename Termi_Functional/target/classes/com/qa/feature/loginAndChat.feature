Feature: Termi Chat
@LoginAndChat
  Scenario: Termi launch and Authentication
    Given Launch Termi in Google Chrome
     When Enter Username and Password from excel at "./Excel_Data/Login_Credentials.xlsx"
      And Click on Login Button
     When Click on Chat icon
     Then Verify that we are on chat page with page title "Termi - Helm 360"
     Then User enters Question and gets Answer from excel at "./Excel_Data/Question_Answer.xlsx"
     #Then User enters Question and gets Answer from excel at "./Excel_Data/Question_Answer2.xlsx"
